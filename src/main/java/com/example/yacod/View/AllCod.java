...
public class AllCod {
    ...
    public static Pane getStartFront(int fl) throws FileNotFoundException, SQLException {
        ...
        pane.setLayoutY(0);
        FileInputStream Url;
        Url = new FileInputStream("png/allcod.png");
        ...
        Button addcod = new Button();
        addcod.setBackground(null);
        addcod.setLayoutY(702);
        addcod.setLayoutX(1080);
        addcod.setPrefSize(70,100);
